...
const tavern_generator = {
    ...
    generate: function () {
        ...
        if (percent < 40) {
            return randomFromList(this.premades);
        }

        var format = randomFromList(this.format);
        for (var i = 0; i < this.descriptors.length; ++i) {
            while (format.indexOf('{{' + this.descriptors[i] + '}}') > -1) {
                format = format.replace('{{' + this.descriptors[i] + '}}', randomFromList(this[this.descriptors[i]]));
            }
        }
        return format;
    },
    ...
    format: [
        '{{adjective}} {{noun}}',
        '{{adjective}} {{noun}} {{tarven_title}}',
        'The {{adjective}} {{noun}}',
        'The {{adjective}} {{noun}} {{tarven_title}}',
        '{{noun}} & {{noun}}',
        '{{noun}} & {{noun}} {{tarven_title}}',
        'The {{noun}} & {{noun}}',
        'The {{noun}} & {{noun}} {{tarven_title}}',
        '{{adjective}} {{tarven_title}}',
        'The {{adjective}} {{tarven_title}}',
    ],
...
module.exports = tavern_generator;
